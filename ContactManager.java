...
public interface ContactManager{
	...
	*/
	...
	/**
	*Returns the PAST meeting with the requested ID, or null if there isn't one.
	*
	*@param id the ID for the meeting
	*@return the meeting with the requested ID, or null if there isn't one.
	...
	*/
	...
	/**
	*Returns the meeting with the requested ID, or null if there isn't one.
	*
	*@param id the ID for the meeting
	*@return the meeting with the requested ID, or null if there isn't one.
	*/
	...
	*
	*If there are none, the returned list will be empty. Otherwise, the list will be chronologically
	*sorted and will not contain any duplicates.
	*
